...
const DESCRIPTIONS: Record<string, string> = {
  getBook: 'Fetch a single book by rkey',
  getBooks: 'List books (paginated)',
  getReviews: 'List reviews for a book',
  getReview: 'Fetch a single review',
  getUserStatus: 'Reading status for a DID',
  searchBooks: 'Full-text search over books',
  getClaims: 'List edition/translation claims',
  getLabelerLabels: 'Labels emitted by the labeler',
  getShelves: 'List public shelves',
  ...
  createClaim: 'Claim an edition/translation',
