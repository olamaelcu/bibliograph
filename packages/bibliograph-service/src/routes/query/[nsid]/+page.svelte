...
<main class="wrapped-content">
  <p><a href="/queries">← All queries</a></p>
  ...
  {#if data.params?.description}
    <p class="muted">{data.params.description}</p>
  {/if}
          ...
          {#each data.params.fields as f}
            <tr>
              ...
              <td>
                ...
                {/if}
                {#if f.defaultValue}
                  <div class="param-meta">default: <code>{f.defaultValue}</code></div>
                {/if}
              </td>
            </tr>
          {/each}
  ...
  {#if data.output?.fields}
    <section>
      ...
      {#if data.output.description}
        <p class="muted">{data.output.description}</p>
      {/if}
      <table>
        <thead>
